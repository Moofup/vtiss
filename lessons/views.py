...
from lessons.serializers import (
    TeacherSerializer, ClassSerializer, UserSerializer
)
...
class UserViewSet(viewsets.ModelViewSet):
    """
    Вьююсет для работы с пользователями.
    Права на изменения записей есть только у администратора.
    """
...
class ClassViewSet(viewsets.ModelViewSet):
    ...
    Администратор может добавлять/изменять/удалять записи.
    """
